...
public class ResultUtil {
    ...
    public static Result success(Object object) {
        ...
        result.setCode(BaseCodeAndMessageEnum.SUCCESS.getCode());
        result.setMsg(BaseCodeAndMessageEnum.SUCCESS.getMessage());
     ...
     * @return result
     */
    public static Result success(CodeAndMessage resultEnum, Object object) {
        Result result = new Result();
    ...
    public static Result fail(String msg) {
        Result result = new Result();
        result.setCode(BaseCodeAndMessageEnum.FAIL.getCode());
        result.setMsg(msg);
        Map<String, Object> map = new HashMap<>();
        map.put("resultData", "");
        result.setData(map);
     ...
     * @return result
     */
    public static Result fail(CodeAndMessage resultEnum) {

        return fail(resultEnum.getCode(), resultEnum.getMessage());
    }


    public static Result of(CodeAndMessage resultEnum) {
        final Result result = new Result(resultEnum.getCode(), resultEnum.getMessage());
        Map<String, Object> map = new HashMap<>();
        map.put("resultData", "");
        result.setData(map);
        return result;
    ...
    public static Result fail() {
        return fail(BaseCodeAndMessageEnum.FAIL.getCode(), BaseCodeAndMessageEnum.FAIL.getMessage());
    }
