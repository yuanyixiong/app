package com.service.module.system;
...
import com.service.module.system.ServiceModuleSystemApplication;
...
@SpringBootTest(classes = ServiceModuleSystemApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class TestGenerator {
    ...
    public void userGenerator() {
        ...
        //要生成的表名
        String tableNames = "app_sys_config";
    ...
    private static PackageConfig getPackageConfig() {
        return new PackageConfig()
                .setParent("com.service.module.system")
